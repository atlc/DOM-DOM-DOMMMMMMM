document.addEventListener("DOMContentLoaded", function () {
    ...
    function attachDivEventListeners(div) {
        ...
        div.addEventListener("dblclick", function () {
            let len = document.getElementsByClassName("divSquare").length;
            ...
            if (div.id % 2 == 0) {
                if (div.id >= len) {
                    ...
                    nextSquare.parentNode.removeChild(nextSquare); // https://stackoverflow.com/questions/3387427/remove-element-by-id#comment3521845_3387427
                }
            } else {
